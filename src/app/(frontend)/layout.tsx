  ...
  return (
    <html className={cn(GeistSans.variable, GeistMono.variable, figtree.variable, archivo.variable)} lang="en" suppressHydrationWarning>
      <head>
        ...
        <InitTheme />
        <link href="/favicon-16x16.svg" rel="icon" sizes="16x16" type="image/svg+xml" />
        <link href="/favicon-32x32.svg" rel="icon" sizes="32x32" type="image/svg+xml" />
        <link href="/favicon-48x48.svg" rel="icon" sizes="48x48" type="image/svg+xml" />
